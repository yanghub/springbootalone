...
$(function() {
	...
	var toolbar =[ 
		...
		{ text : '权限管理', validCount : '1',
			handler : function(rows) {
				modal.open({ title:'编辑 ['+rows[0].userName+'] 用户权限'+'<font color="red">(红色部分为角色权限)</font>', width:400, height:430, 
					url:'userController/openUserPowerPageChange?editUserId='+rows[0].userId+'&editUserRoleId='+rows[0].userRoleId 
				})
			}	
		},
	]
