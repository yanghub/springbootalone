...
<script type="text/javascript">
	$(function(){
		...
		var toolbar = [
			...
			{text : '基本功能设置',validCount : '1',verify:function(rows){
				if(rows[0].menuLevel =='一级菜单'){
					return false;
				}
				return true;
			},handler : function(rows){
				modal.open({title:'编辑 ['+rows[0].menuName+'] 基本功能',width:400,height:430,url:'menuController/openBaseFuncPage?strMenuId='+rows[0].menuId})
			}},
		]
					...
					<div class="widget-screen">
						...
						<div class="widget-item">
							<select class="form-control" id=menuPid name="menuPid" >
								...
								<option value="9020000">站点管理</option>
							</select>
						</div>
					</div>	
