...
// 		$("#searchFlag").comboBox();
		...
		var toolbar = [
			{text : '新增',validCount : '0+',handler : function(rows){
				modal.open({title:'新增服饰',url:'T9Controller/openEdit'})
			}},
			{text : '修改',validCount : '1',handler : function(rows){
				modal.open({title:'编辑服饰',url:'T9Controller/openEdit?id='+rows[0].id})
			}},
		...
		//列表方法
		$('#table').datagrid({
			url : 'T9Controller/selectList',//查询数据的地址
			form : 'selectform',//用于筛选的form id
			//字段
			columns : [
				{field : 'aaa',title : '服饰编号',width : 90},
				{field : 'bbb',title : '服饰名称',width : 90},
				{field : 'ccc',title : '服装风格',width : 90},
				{field : 'ddd',title : '图片链接',width : 300},
				{field : 'eee',title : '联系电话',width : 90},
			...
			<div class="widget-control">
				...
				<input id="queryCondition"type="hidden" name="queryCondition" >
					<div class="widget-screen">
						<label for="aaa" class="control-label">服饰编号</label>
						<div class="widget-item">
							<input class="form-control" name="aaa" type="text" placeholder="服饰编号查询">
						</div>
					</div>
<!-- 					<div class="widget-screen"> -->
<!-- 						<label for="bbb" class="control-label">服饰名称</label> -->
<!-- 						<div class="widget-item"> -->
<!-- 							<input class="form-control" name="bbb" type="text" placeholder="服饰名称查询"> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					<div class="widget-screen"> -->
<!-- 						<label for="ccc" class="control-label">适宜人群</label> -->
<!-- 						<div class="widget-item"> -->
<!-- 							<input class="form-control" name="ccc" type="text" placeholder="适宜人群查询"> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					<div class="widget-screen"> -->
<!-- 						<label for="ddd" class="control-label">图片链接</label> -->
<!-- 						<div class="widget-item"> -->
<!-- 							<input class="form-control" name="ddd" type="text" placeholder="图片链接查询"> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					<div class="widget-screen"> -->
<!-- 						<label for="eee" class="control-label">联系电话</label> -->
<!-- 						<div class="widget-item"> -->
<!-- 							<input class="form-control" name="eee" type="text" placeholder="联系电话查询"> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					<div class="widget-screen"> -->
