...
// 		$("#searchFlag").comboBox();
		...
		var toolbar = [
			{text : '新增',validCount : '0+',handler : function(rows){
				modal.open({title:'新增作品',url:'T7Controller/openEdit'})
			}},
			{text : '修改',validCount : '1',handler : function(rows){
				modal.open({title:'编辑作品',url:'T7Controller/openEdit?id='+rows[0].id})
			}},
		...
		//列表方法
		$('#table').datagrid({
			url : 'T7Controller/selectList',//查询数据的地址
			form : 'selectform',//用于筛选的form id
			//字段
			columns : [
				{field : 'aaa',title : '发布者',width : 50},
				{field : 'bbb',title : '作品名称',width : 50},
				{field : 'ccc',title : '作品链接',width : 200},
// 				{field : 'ddd',title : 't04',width : 120},
			...
			<div class="widget-control">
				...
				<input id="queryCondition"type="hidden" name="queryCondition" >
					<div class="widget-screen">
						<label for="aaa" class="control-label">作品编号</label>
						<div class="widget-item">
							<input class="form-control" name="aaa" type="text" placeholder="作品编号查询">
						</div>
					</div>
<!-- 					<div class="widget-screen"> -->
<!-- 						<label for="bbb" class="control-label">作品名称</label> -->
<!-- 						<div class="widget-item"> -->
<!-- 							<input class="form-control" name="bbb" type="text" placeholder="作品名称查询"> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					<div class="widget-screen"> -->
<!-- 						<label for="ccc" class="control-label">作品链接</label> -->
<!-- 						<div class="widget-item"> -->
<!-- 							<input class="form-control" name="ccc" type="text" placeholder="作品链接查询"> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					<div class="widget-screen"> -->
