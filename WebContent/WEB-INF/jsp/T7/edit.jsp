...
function save(){
	if($.valid()){
		var urlAddress = "T7Controller/update";
		if($('#hidId').val()==""){//新增
			urlAddress = "T7Controller/insert";
		}
	...
	<div class="modal-body">
		<form id="editForm" class="form-horizontal no-margin">
			...
			<div class="form-group">
				<label for="aaa" class="col-sm-3 col-xs-3 control-label">发布者</label>
				<div class="col-sm-8 col-xs-8">
					<input id="aaa" value="${entity.aaa}" name="aaa" class="form-control" type="text"/>
				</div>
			</div>
			<div class="form-group">
				<label for="bbb" class="col-sm-3 col-xs-3 control-label">作品名称</label>
				<div class="col-sm-8 col-xs-8">
					<input id="bbb" value="${entity.bbb}" name="bbb" class="form-control" type="text"/>
				</div>
			</div>
			<div class="form-group">
				<label for="ccc" class="col-sm-3 col-xs-3 control-label">作品链接</label>
				<div class="col-sm-8 col-xs-8">
