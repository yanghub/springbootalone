	...
	<div class="modal-body">
		<form id="editForm" class="form-horizontal no-margin">
			...
			<div class="form-group">
				<label for="aaa" class="col-sm-3 col-xs-3 control-label">摄影师预约信息</label>
				<div class="col-sm-8 col-xs-8">
					<input id="aaa" value="${entity.aaa}" name="aaa" class="form-control" type="text"/>
				</div>
			</div>
			<div class="form-group">
				<label for="bbb" class="col-sm-3 col-xs-3 control-label">模特预约信息</label>
				<div class="col-sm-8 col-xs-8">
					<input id="bbb" value="${entity.bbb}" name="bbb" class="form-control" type="text"/>
				</div>
			</div>
						<div class="form-group">
				<label for="ttt" class="col-sm-3 col-xs-3 control-label">预约时间</label>
				<div class="col-sm-8 col-xs-8">
...
<!-- 			</div> -->
<!-- 			<div class="form-group"> -->
<!-- 				<label for="ddd" class="col-sm-3 col-xs-3 control-label">t04</label> -->
<!-- 				<div class="col-sm-8 col-xs-8"> -->
