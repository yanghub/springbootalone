...
function save(){
	if($.valid()){
		var urlAddress = "T8Controller/update";
		if($('#hidId').val()==""){//新增
			urlAddress = "T8Controller/insert";
		}
...
<!-- 				<label for="aaa" class="col-sm-3 col-xs-3 control-label">您的用户编号</label> -->
<!-- 				<div class="col-sm-8 col-xs-8"> -->
<%-- 					<input id="aaa" value="${entity.aaa}" name="aaa" class="form-control" type="text"/> --%>
<!-- 				</div> -->
<!-- 			</div> -->
			<div class="form-group">
				<label for="bbb" class="col-sm-3 col-xs-3 control-label">模特信息</label>
				<div class="col-sm-8 col-xs-8">
					<input id="bbb" readonly="readonly" value="${entity.bbb}" name="bbb" class="form-control" type="text"/>
				</div>
			</div>
<!-- 			<div class="form-group"> -->
<!-- 				<label for="ccc" class="col-sm-3 col-xs-3 control-label">预约时间</label> -->
<!-- 				<div class="col-sm-8 col-xs-8"> -->
...
<!-- 			</div> -->
						...
						<div class="form-group">
				<label for="ddd" class="col-sm-3 col-xs-3 control-label">评价等级</label>
				<div class="col-sm-8 col-xs-8">
...
<!-- 			<div class="form-group"> -->
<!-- 				<label for="eee" class="col-sm-3 col-xs-3 control-label">t05</label> -->
<!-- 				<div class="col-sm-8 col-xs-8"> -->
